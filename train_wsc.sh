#!/bin/bash
#SBATCH --job-name=t5_base_wsc
#SBATCH --gpus=ampere:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=32

# Script to train T5-base on WSC dataset
# Trains for 75,000 steps as per train_tips.txt
# Saves checkpoint in: models/wsc/best.pt
...
# Train T5-base on WSC dataset
# inference_dataset_mixture=None ensures evaluation only on WSC (same as train_dataset)
python src/training.py \
    ...
    experiment_name=t5-base-wsc \
    num_batches=75000

echo "Training completed for WSC dataset"
