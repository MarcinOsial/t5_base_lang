#!/bin/bash
#SBATCH --job-name=t5_base_qasc
#SBATCH --gpus=ampere:1
#SBATCH --mem=64G
#SBATCH --cpus-per-task=32

# Script to train T5-base on QASC dataset
# Trains for 75,000 steps as per train_tips.txt
# Saves checkpoint in: models/qasc/best.pt
...
# Train T5-base on QASC dataset
# inference_dataset_mixture=None ensures evaluation only on QASC (same as train_dataset)
python src/training.py \
    ...
    experiment_name=t5-base-qasc \
    num_batches=75000

echo "Training completed for QASC dataset"
